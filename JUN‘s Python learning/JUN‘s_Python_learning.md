...
![16](./JUN‘s_Python_learning.assets/16.png)
...
5. **`__call__`方法**
    ...
    当一个类实现了 `__call__` 方法后，创建该类的实例后，可以直接使用括号调用该实例。
...
![6](./JUN‘s_Python_learning.assets/6.png)
